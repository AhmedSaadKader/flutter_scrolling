  ...
  static ScrollThumbBuilder _thumbSemicircleBuilder(
    ...
    return (
      ...
      return SemicircleScrollThumb(
        ...
        alwaysVisible: alwaysVisibleScrollThumb,
      );
    };
  }
}
...
class ScrollThumbWithLabel extends StatelessWidget {
...
class SemicircleScrollThumb extends StatelessWidget {
  final double width;
  final double height;
  final Color backgroundColor;
  final Animation<double> thumbAnimation;
  ...
  Widget build(BuildContext context) {
    ...
    return ScrollThumbWithLabel(
      ...
      labelText: labelText,
      labelConstraints: labelConstraints,
      alwaysVisibleScrollThumb: alwaysVisible,
    );
  }
}
